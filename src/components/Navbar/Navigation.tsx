      ...
      <div className="flex justify-end items-center max-lg:hidden gap-4 h-full">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className={`flex items-center mr-3 h-full border-y-2 border-transparent hover:text-violet-300 ${
              pathname === link.href && "!border-blue-300 text-violet-300"
            }`}
          >
            {link.label}
          </Link>
        ...
        <div
          className={`flex items-center gap-1 h-full ${
            !search && "tooltip tooltip-bottom tooltip-accent"
          }`}
          data-tip="Search"
        >
          {search && (
        ...
        {user ? (
          <>
            <div
              className="flex items-center h-full tooltip tooltip-bottom tooltip-accent"
              ...
              <div className="flex flex-row justify-center items-center gap-3">
                {links.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`flex items-center h-full border-y-2 border-transparent hover:text-violet-300 ${
                      pathname === link.href &&
                      "!border-blue-300 text-violet-300"
                    }`}
                  >
                    {link.label}
                  </Link>
